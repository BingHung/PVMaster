Module FlangeDesign
    ...
    Dim T, P, Ca, S, B, g0, Fs, Sf, m, y, tg, w, N, N1, Sb, Sa, nb, Db As Double
    ...
    Public Structure FlangeDesign_Parameters_Output

        Dim FOD, FID, FTHK, BCD As Double
        Dim GID, GOD, GTHK As Double
        Dim nb, Db As Double
        Dim g0, g1, h As Double

    End Structure

    Public Structure FlangeDesign_Parameters_Input

        Dim P, T, Ca As Double
        Dim S, B, g0 As Double
        Dim Fs, Sf As Double
        Dim GSTP, GSSk As String
        Dim m, y, tg, w, N, N1 As Double
        Dim Sa, Sb, Dbi As Double
    End Structure

    Public Function FlangeDesign_Main(ByVal FDP_In As FlangeDesign_Parameters_Input) As FlangeDesign_Parameters_Output

        Dim FDP_Out As New FlangeDesign_Parameters_Output
        ...
        FDP_Out.FOD = aResult(1)
        FDP_Out.FID = aResult(2)
        FDP_Out.BCD = aResult(3)
        FDP_Out.FTHK = aResult(4)
        FDP_Out.h = aResult(5)
        FDP_Out.g0 = aResult(6)
        FDP_Out.g1 = aResult(7)
        FDP_Out.GOD = aResult(8)
        FDP_Out.GID = aResult(9)
        FDP_Out.nb = aResult(10)
        FDP_Out.Db = aResult(11)
